...
/**
 * Prints the nth number of pi followed by the next 8 numbers in base 10. This
 * program is based on Bellard's work.
 * 
 * @author feltocraig
 * @url https://github.com/feltocraig/BBP-Bellard/blob/master/Bpp.java
 */
